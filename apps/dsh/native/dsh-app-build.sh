...
SWIFT_SOURCES=(DSHApp.swift Runtime.swift TitlebarDragController.swift WebNavigationController.swift StartupPageController.swift AppUpdater.swift UpdateCoordinator.swift)
